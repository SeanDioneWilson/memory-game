...
This is my attempt at a functional memory game project. In order to test it out, all you have to do is clone the code and run the index.html in a web browser making sure the css and js files are linked correctly. 
